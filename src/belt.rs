...
// Keep in sync...
pub const CELL_BELT_TYPE_COUNT: usize = (BeltType::DRU_L as usize) + 1;
...
// < │
// └^┘
pub const CELL_BELT_D_UL: BeltMeta = BeltMeta {
  btype: BeltType::D_UL,
  dbg: "BELT_D_UL",
  src: "./img/d_ul.png",
  direction_u: Port::Outbound,
...
// > >
// └v┘
pub const CELL_BELT_LD_RU: BeltMeta = BeltMeta {
...
// > <
// └v┘
pub const CELL_BELT_RLU_D: BeltMeta = BeltMeta {
