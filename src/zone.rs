...
pub const UI_UNREDO_OFFSET_X: f64 = GRID_X2 + 30.0 - (UI_UNREDO_WIDTH * 4.0 + UI_UNREDO_MARGIN * 3.0);
...
pub const UI_UNREDO_PAINT_TOGGLE_X: f64 = GRID_X2; // UI_UNREDO_OFFSET_X + 3.0 * (UI_UNREDO_WIDTH + UI_UNREDO_MARGIN);
...
pub const UI_SAVE_MENU_W: f64 = UI_SAVE_THUMB_WIDTH + UI_SAVE_MARGIN + UI_SAVE_THUMB_WIDTH + UI_SAVE_MARGIN + UI_CLIPBOARD_WIDTH;
...
pub const UI_CLIPBOARD_WIDTH: f64 = UI_SMALL_BUTTON_WIDTH;
pub const UI_CLIPBOARD_HEIGHT: f64 = UI_SMALL_BUTTON_HEIGHT;
pub const UI_CLIPBOARD_COPY_X: f64 = 2.0 * UI_SAVE_THUMB_WIDTH + 2.0 * UI_SAVE_MARGIN; // relative to UI_SAVE_MENU_OFFSET_X
pub const UI_CLIPBOARD_COPY_Y: f64 = 0.0; // Relative to UI_SAVE_MENU_OFFSET_Y
pub const UI_CLIPBOARD_PASTE_X: f64 = UI_CLIPBOARD_COPY_X;
pub const UI_CLIPBOARD_PASTE_Y: f64 = UI_CLIPBOARD_COPY_Y + UI_SAVE_THUMB_HEIGHT + UI_SAVE_MARGIN;
...
pub const UI_LOGO_X: f64 = UI_MENU_BUTTONS_OFFSET_X + 100.0;
