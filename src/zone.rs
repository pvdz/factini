...
pub const UI_MENU_BOTTOM_MACHINE_X: f64 = UI_MENU_BUTTONS_OFFSET_X +UI_MENU_BUTTONS_WIDTH_MAX + 5.0;
...
pub const UI_DEBUG_LINES: f64 = 9.0; // Update after adding more lines
...
pub const UI_OFFERS_PER_ROW: f64 = 3.0;
