...
pub const UI_UNREDO_OFFSET_X: f64 = GRID_X2 - 55.0 - (UI_UNREDO_WIDTH * 4.0 + UI_UNREDO_MARGIN * 3.0);
pub const UI_UNREDO_OFFSET_Y: f64 = GRID_Y0 + 5.0;
...
pub const UI_SPEED_BUBBLE_OFFSET_X: f64 = UI_TOP_OFFSET_X + 150.0;
